...
1. [Registered Nurses Data](https://github.com/rfordatascience/tidytuesday/blob/master/data/2021/2021-10-05/readme.md). Read in the data manually as shown in class.

2. [Netflix Titles](https://github.com/rfordatascience/tidytuesday/blob/master/data/2021/2021-04-20/readme.md). Read in the data manually as shown in class.

3. [TV's Golden Age](https://github.com/rfordatascience/tidytuesday/tree/master/data/2019/2019-01-08). Read in the data manually as shown in class.
